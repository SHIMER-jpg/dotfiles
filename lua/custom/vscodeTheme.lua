...
hl(0, '@keyword.alias', { fg = c.vscPink, bg = 'NONE' }
...
hl(0, 'IndentBlanklineContextStart', { sp = c.vscContextCurrent, bg = 'NONE', nocombine = true }
...
hl(0, 'DiagnosticInfo', { fg = c.vscGray, bg = 'NONE' }
hl(0, 'DiagnosticHint', { fg = c.vscGray, bg = 'NONE' }
